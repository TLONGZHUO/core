...
public class HttpClientUtil {
    ...
    public static void main(String[] args) {
        ...
        headers.put("X-timevale-project-id", "1111563517");
        headers.put("X-timevale-signature", "45ef3ef60aa50fde42f527171864b147d0fe5151ff829ac91debe7722f219f46");
        headers.put("signature-algorithm", "HmacSHA256");
        headers.put("Content-Type", "application/json");
        headers.put("Charset", "UTF-8");
        params.put("mobile", "15958300512");
        params.put("name", "唐小糖");
        params.put("cardno", "6222021304008302619");
        params.put("idno", "330482199308080056");
        postJson("http://smltech.tsign.cn:8080/openapi_tech/rest/v2/realname/person/bankauthApply", JSONObject.toJSONString(params), headers, "UTF-8");
    }
    ...
    /**
     * Post方式提交,指定header参数,body提交json
     *
     * @param url      提交地址
     * @param jsonInfo 请求参数json
     * @param headers  提交header参数集, 键/值对
     * @param charset  参数提交编码集
     * @return 响应消息
     */
    public static String postJson(String url, String jsonInfo, Map<String, String> headers, String charset) {
        if (url == null || StringUtils.isEmpty(url)) {
            return null;
        }
        // 创建HttpClient实例
        ...
        hp.setEntity(new StringEntity(jsonInfo, charset));
        // 发送请求，得到响应
        String responseStr = null;
        try {
            responseStr = httpclient.execute(hp, responseHandler);
    ...
    public static String post(String url, Map<String, String> params, Map<String, String> headers) {
        ...
        // 创建HttpClient实例
        CloseableHttpClient httpclient = getHttpClient("UTF-8");
